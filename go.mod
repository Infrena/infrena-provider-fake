...
// The require is the infrena RELEASE this plugin is built and tested against: v0.5.0, the release
// whose configuration grammar writes a variable as ${var.x}, which every example in this repository
// uses. v0.4.0 is the oldest release a require on this path can name: Infrata was renamed Infrena
// on 2026-09-14, and tags v0.1.0 to v0.3.0 declare the old path, github.com/infrata/infrata.
//
