...
// The require is the infrena RELEASE this plugin is built and tested against. v0.4.0 is the first
// release under the module path github.com/infrena/infrena: Infrata was renamed Infrena on
// 2026-09-14, and tags v0.1.0 to v0.3.0 declare the old path, github.com/infrata/infrata, so none
// of them can satisfy this require.
//
