...
workflow that has not been exercised yet (no tag has been pushed, and no `INFRATA_CHECKOUT_TOKEN`
secret is configured for it to check infrata out with). The implementation followed
